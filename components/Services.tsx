        ...
        <div className="px-4 w-full lg:w-1/3">
          <Card type="hover">
            ...
            <div className="pt-6">
              <Link
                href="/"
                className="font-bold text-xl sm:text-2xl hover:text-ct-blue transition-colors duration-300"
              >
                Clean
              </Link>
              <Paragraph align="center" className="my-5">
              ...
              <div className="flex justify-center">
                <Link
                  href="/"
                  className="group/link flex gap-2 items-center hover:text-ct-blue transition-colors duration-300"
                >
